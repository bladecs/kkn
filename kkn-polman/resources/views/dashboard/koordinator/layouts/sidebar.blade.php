    ...
    <ul class="list-unstyled components">
        ...
        <li class="dropdown-menu-container {{ request()->routeIs('formulir') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu-custom">
                ...
                <li>
                    <a href="{{ route('data-diri') }}" class="dropdown-menu-item">
                        <i class="fas fa-id-card"></i> <span>Pengelompokan</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="dropdown-menu-container {{ request()->routeIs('pelaporan-harian') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu-custom">
                <li>
                    <a href="{{ route('pelaporan-harian') }}"
                        class="dropdown-menu-item {{ request()->routeIs('pelaporan-harian') ? 'active' : '' }}">
                        <i class="fas fa-file-invoice"></i> <span>Laporan Harian</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-menu-item">
